...
# doc=""" One of the most important things I didn't understand about the world when I was a child is the degree to which the returns for performance are superlinear.
...
# loader=PyPDFLoader("C:/HARDIK YADAV/Lang/books/Introduction to PyTorch.pdf")
